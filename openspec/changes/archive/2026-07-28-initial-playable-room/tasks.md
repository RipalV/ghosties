...
- [x] Create Phaser + TypeScript + Vite project structure.
- [x] Add responsive game canvas.
- [x] Add keyboard and pointer/touch ghost movement.
- [x] Add one wandering NPC.
- [x] Add three starting abilities.
- [x] Add fear profile and novelty calculations.
- [x] Add score, energy, fear stage, and status feedback.
