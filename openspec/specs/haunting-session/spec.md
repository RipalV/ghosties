# haunting-session Specification

## Purpose
Typed haunting visit phases, results, next-visit restart, and session-scoped reset — including deterministic visitor rotation.
## Requirements
