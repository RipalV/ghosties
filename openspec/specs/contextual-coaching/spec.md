# contextual-coaching Specification

## Purpose

Brief contextual hints after guided onboarding ends: range, observe, clues, exposure, and route coaching without pausing the visitor or changing gameplay outcomes.
